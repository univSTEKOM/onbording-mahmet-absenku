...
const PERSONAS = [
  {
    ...
    jabatan: 'Manager HRD', phone: '081234567890', alamat: 'Jl. Merdeka No. 1, Jakarta',
    status: 'approved',
    weights: null,
  },
  {
    email: 'rudi@stekom.ac.id', name: 'Rudi Hartono', role: 'karyawan',
    jabatan: 'Staff IT', phone: '081234567891', alamat: 'Jl. Sudirman No. 2, Jakarta',
    status: 'approved',
  ...
  },
  {
    ...
    jabatan: 'Staff Keuangan', phone: '081234567892', alamat: 'Jl. Gatot Subroto No. 3, Jakarta',
    status: 'approved',
  ...
  },
  {
    ...
    jabatan: 'Staff Baru', phone: '081234567893', alamat: 'Jl. Baru No. 1, Jakarta',
    status: 'pending',
  ...
  },
  {
    ...
    jabatan: 'Staff Marketing', phone: '081234567894', alamat: 'Jl. Asia Afrika No. 4, Bandung',
    status: 'approved',
  ...
  },
  {
    ...
    jabatan: 'Staff HR', phone: '081234567895', alamat: 'Jl. Diponegoro No. 5, Jakarta',
    status: 'approved',
  ...
  },
  {
    ...
    jabatan: 'Staff Gudang', phone: '081234567896', alamat: 'Jl. Pahlawan No. 6, Surabaya',
    status: 'approved',
  ...
  },
  {
    ...
    jabatan: 'Staff Magang', phone: '081234567897', alamat: 'Jl. Merapi No. 7, Yogyakarta',
    status: 'pending',
