...
export const verificationSteps: TourStepDef[] = [
  ...
  },
  {
    ...
    description: 'Klik avatar kamu di sini untuk membuka dropdown — ada opsi ke halaman Profil atau Logout.',
    icon: 'User',
    position: 'top',
    route: '/profil',
  },
  {
    id: 'v-profile-card',
    type: 'spotlight',
    targetSelector: '[data-slot="profile-card"]',
    title: 'Lengkapi Data Diri',
    description: 'Sambil menunggu verifikasi, lengkapi profil kamu. Foto dan data yang jelas mempercepat proses.',
    icon: 'UserCheck',
    position: 'bottom',
    route: '/profil',
  },
